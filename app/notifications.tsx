  ...
  const renderNotification = (item: Notification) => {
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          styles.notiCard,
          item.is_read ? styles.notiCardRead : styles.notiCardUnread,
        ]}
        activeOpacity={0.7}
        onPress={() => {
        ...
        <View style={styles.notiContent}>
          ...
          <View style={styles.notiFooter}>
            ...
            {iconData.action !== "" && (
              ...
              >
                <Text style={[styles.actionText, { color: iconData.color }]}>
                  {iconData.action}
                </Text>
              </TouchableOpacity>
            )}

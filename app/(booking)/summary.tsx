...
export default function SummaryScreen() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      bookingsToInsert.push({
        ...
        total_price:
          tripType === "round-trip" ? Number(outboundPrice) : netPrice,
        status: "Confirmed",
        trip_id: tripType === "round-trip" ? outboundTripId : trip_id,
        selected_seats:
          tripType === "round-trip"
            ? String(outboundSeats)
  ...
  const renderTicketCard = (type: "go" | "return") => {
    ...
    const cardDepTime =
      isGo && tripType === "round-trip" ? outboundDepTime : depTime;
    const cardArrTime =
      isGo && tripType === "round-trip" ? outboundArrTime : arrTime;
    const cardCabin =
      isGo && tripType === "round-trip" ? outboundCabin : cabinNumber;
    const cardSeats =
      isGo && tripType === "round-trip" ? outboundSeats : selectedSeats;
    const cardDuration =
      isGo && tripType === "round-trip" ? outboundDuration : duration;
    const cardPrice =
      isGo && tripType === "round-trip"
        ? Number(outboundPrice)
        : tripType === "round-trip"
          ? netPrice - Number(outboundPrice)
          : netPrice;
      ...
      <View style={styles.ticketCard}>
        <View style={styles.badgeRow}>
          <View
            style={[
              styles.badge,
              { backgroundColor: isGo ? "#E8F5E9" : "#FCE4EC" },
            ]}
          >
            <Text
              style={[
                styles.badgeText,
                { color: isGo ? "#4CAF50" : "#E91E63" },
              ]}
            >
              {isGo ? "ขาไป" : "ขากลับ"}
            </Text>
        ...
        <View style={styles.infoGrid}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoLabelRight} numberOfLines={1}>
              {formatSeatsWithType(String(cardSeats))}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.priceRow}>
          ...
          <Text style={styles.priceTextMain}>
            THB {cardPrice.toLocaleString("en-US")}
          </Text>
        </View>
      </View>
    );
      ...
      <SafeAreaView style={styles.safeArea} edges={["top"]}>
        ...
        >
          ...
          <View style={styles.paymentCard}>
            ...
            >
              <View style={[styles.payIconBox, { backgroundColor: "#EBE4FF" }]}>
                <Ionicons name="card" size={20} color="#5E35B1" />
              </View>
              ...
              <Ionicons
                ...
                size={24}
                color={paymentMethod === "credit" ? "#5E35B1" : "#E0E0E0"}
              />
            </TouchableOpacity>
            ...
            >
              <View style={[styles.payIconBox, { backgroundColor: "#D4F1E5" }]}>
              ...
              <Ionicons
                ...
                size={24}
                color={paymentMethod === "promptpay" ? "#5E35B1" : "#E0E0E0"}
              />
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.paymentOption}
              onPress={() => setPaymentMethod("truemoney")}
            >
              <View style={[styles.payIconBox, { backgroundColor: "#FFF59D" }]}>
                <Ionicons name="wallet" size={20} color="#FBC02D" />
              </View>
              <View style={{ flex: 1, marginLeft: 15 }}>
              ...
              <Ionicons
                ...
                size={24}
                color={paymentMethod === "truemoney" ? "#5E35B1" : "#E0E0E0"}
              />
            </TouchableOpacity>
            ...
            >
              ...
              <Ionicons
                ...
                size={24}
                color={paymentMethod === "qr" ? "#5E35B1" : "#E0E0E0"}
              />
            </TouchableOpacity>
          </View>
        </ScrollView>
      ...
      <View style={styles.bottomFooter}>
        <View style={styles.footerPriceRow}>
          <Text style={styles.footerLabel}>
            ยอดสุทธิ {tripType === "round-trip" ? "(ไป-กลับ)" : ""}:
          </Text>
          <Text style={styles.footerPriceValue}>
            THB {netPrice.toLocaleString("en-US")}
          </Text>
        </View>
        <TouchableOpacity
          ...
          <View style={styles.alertBox}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    alertConfig.type === "success" ? "#E8F5E9" : "#FFEBEE",
                },
              ]}
            >
              <Ionicons
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    alertConfig.type === "success" ? "#262956" : "#F44336",
                },
              ]}

          ...
          coupons.map((coupon) => (
            <View key={coupon.id} style={styles.couponCard}>
              <View
                style={[
                  styles.colorBar,
                  { backgroundColor: coupon.color || "#5E35B1" },
                ]}
              />
              ...
              <View style={styles.cardContent}>
                <View style={{ flex: 1, paddingRight: 15 }}>
                  ...
                  >
                    ลดราคา: {coupon.discount_amount} บาท
                  </Text>
                  <Text style={styles.couponExp}>
                    หมดเขต: {coupon.expire_date}
                  </Text>
                </View>
        ...
        <View style={styles.addCodeSection}>
          ...
          <View style={styles.inputBox}>
            <MaterialCommunityIcons
              ...
              color="#9E9E9E"
            />
            <Text style={{ flex: 1, marginLeft: 10, color: "#9E9E9E" }}>
              พิมพ์โค้ดส่วนลดที่นี่...
            </Text>
            <TouchableOpacity
              ...
              onPress={() =>
                showCustomAlert(
                  "ขออภัย",
                  "ขณะนี้ระบบยังไม่เปิดให้เพิ่มโค้ดด้วยตนเอง",
                )
              }
            >

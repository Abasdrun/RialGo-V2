      ...
      >
        ...
        <View style={styles.quickMenuSection}>
          ...
          <View style={styles.menuRow}>
            <TouchableOpacity
              ...
              onPress={() => router.push("/(booking)/book-ticket")}
            >
              <View
                style={[styles.menuIconSquare, { backgroundColor: "#D0CDE1" }]}
              >
            ...
            >
              <View
                style={[styles.menuIconSquare, { backgroundColor: "#C9F2E3" }]}
              >
                <MaterialCommunityIcons
            ...
            >
              <View
                style={[styles.menuIconSquare, { backgroundColor: "#F6E5A8" }]}
              >
        ...
        <View style={styles.gridContainer}>
          <View style={styles.gridBox}>
            {bannerSlots["grid_left_top"] && (
              <Image
                source={{ uri: bannerSlots["grid_left_top"] }}
          ...
          <View style={styles.gridBox}>
            {bannerSlots["grid_right"] && (
              <Image
                source={{ uri: bannerSlots["grid_right"] }}
                style={styles.gridImageFull}
                resizeMode="cover"
              />
            )}

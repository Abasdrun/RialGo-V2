...
export default function ProfileScreen() {
  ...
  const fetchUserData = async () => {
    try {
      ...
      if (user) {
        ...
        const displayName =
          profileData?.full_name || user.user_metadata?.full_name || "Yoon";
        setName(displayName);
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      Alert.alert(
        "เกิดข้อผิดพลาด",
        error.message || "ไม่สามารถอัปเดตข้อมูลได้",
      );
    } finally {
      setIsUpdating(false);
    }
        ...
        >
          ...
          <View style={styles.menuCard}>
            <TouchableOpacity style={styles.menuRow} onPress={openEditModal}>
              <View
                style={[styles.menuIconBox, { backgroundColor: "#EBE4FF" }]}
              >
            ...
            <TouchableOpacity style={styles.menuRow}>
              <View
                style={[styles.menuIconBox, { backgroundColor: "#E0F2F1" }]}
              >
                <Ionicons
              ...
              <View style={styles.menuBadgePurple}>
                <Text style={styles.menuBadgeTextWhite}>2 ใบ</Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color="#BDBDBD" />
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.menuRow}>
              <View
                style={[styles.menuIconBox, { backgroundColor: "#FFF9C4" }]}
              >
            ...
            <TouchableOpacity style={styles.menuRow}>
              <View
                style={[styles.menuIconBox, { backgroundColor: "#EDE7F6" }]}
              >
              ...
              <View style={styles.menuBadgeYellow}>
                <Text style={styles.menuBadgeTextYellow}>2,350 pts</Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color="#BDBDBD" />
            </TouchableOpacity>
            ...
            >
              <View
                style={[styles.menuIconBox, { backgroundColor: "#FFEBEE" }]}
              >
                <Ionicons name="log-out-outline" size={20} color="#F44336" />
              </View>
              <View style={styles.menuTextCol}>
                <Text style={[styles.menuMainText, { color: "#F44336" }]}>
                  ออกจากระบบ
                </Text>
                <Text style={styles.menuSubText}>
                  ลงชื่อออกเพื่อสลับบัญชีผู้ใช้
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color="#BDBDBD" />
            </TouchableOpacity>
